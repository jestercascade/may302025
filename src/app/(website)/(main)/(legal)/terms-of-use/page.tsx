        ...
        <div className="w-[736px]">
          <div className={styles.richtext}>
            ...
            <p>
              ...
              arbitration agreement and class action waiver (see Section 13). By
              agreeing to these Terms, you waive your right to participate in
              class actions and agree to resolve disputes through individual
              arbitration. Please review Section 13 carefully.
            </p>
            <p>
              ...
              additional terms, the additional terms will take precedence unless
              stated otherwise.
            </p>
            <hr />
            ...
            <p>
              All products are subject to availability. We may limit quantities
              per order and reserve the right to refuse sales to resellers or
              cancel orders suspected of resale intent.
            </p>
            <h4>(c) Pricing</h4>
            <p>
            ...
            <p>
              An order confirmation email does not mean your order is accepted.
              We reserve the right to decline any order (e.g., due to stock
              issues or suspected fraud). Acceptance occurs when we send a
            ...
            <p>
              Sales taxes will be added at checkout for applicable regions. For
              international orders, you are responsible for all customs duties,
              taxes, and fees.
            </p>
            ...
            <p>
              Promotions, discounts, or contests may have separate rules. Check
              those rules for eligibility and details before participating.
            </p>
            <hr />
            ...
            <p>
              ...
              our Materials without our written permission.
            </p>
            ...
            <p>
              If you submit reviews, photos, or comments (“User Content”), you:
            </p>
            <ul>
              <li>
            ...
            <p>
              ...
              Cherlygood.com makes no warranties, express or implied, including
              about merchantability, fitness for a specific purpose, or
              non-infringement. We don’t guarantee the Sites will be error-free
            ...
            <p>
              ...
              Sites. Our maximum liability for any claim is limited to what you
              paid for the product or service involved.
            </p>
            <hr />
            <h3 id="10-indemnification">10. Indemnification</h3>
            <p>
              You agree to defend and indemnify Cherlygood.com, its affiliates,
              and their employees against claims, damages, or costs (including
              legal fees) arising from your use of the Sites, violation of these
              Terms, or infringement of others’ rights.
            </p>
            <hr />
            <h3 id="11-termination">11. Termination</h3>
            <p>
              We may suspend or terminate your access to the Sites at any time,
              with or without cause (e.g., for violating these Terms). You must
              stop using the Sites if terminated.
            </p>
            <hr />
            <h3 id="12-governing-law">12. Governing Law</h3>
            <p>
              These Terms are governed by the laws of California, excluding its
            ...
            <p>
              You may use small claims court instead of arbitration for eligible
              claims.
            </p>
            <hr />
            ...
            <p>
              ...
              posted on this page, and your continued use of the Sites means you
              accept them.
            </p>
            <hr />
            ...
            <ul>
              ...
              <li>
                <strong>No Waiver</strong>: Not enforcing a rule doesn’t mean we
                waive it.
              </li>
              <li>
                <strong>Assignment</strong>: You can’t transfer these Terms; we
                can with notice.
              </li>
            </ul>
            <hr />
