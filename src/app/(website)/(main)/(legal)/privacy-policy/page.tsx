        ...
        <div className="w-[736px]">
          <div className={styles.richtext}>
            <p>
              ...
              uses, and shares your personal information when you visit or shop
              on our website (the “Site”). By using the Site, you agree to the
              practices described in this policy. If you don’t agree, please
              don’t use the Site.
            </p>
            <p>
              <strong>For International Visitors:</strong> Our Site is hosted in
              the United States. If you’re accessing it from outside the U.S.,
              your information will be transferred to and stored in the U.S.,
              where privacy laws may differ from your country. Using the Site
              means you consent to this.
            </p>
            <hr />
            ...
            <ul>
              ...
              <li>
                ...
                details. (Don’t worry—we don’t store this; it’s handled securely
                by our payment processors.)
              </li>
              <li>
                <strong>Online Activity</strong>: Your IP address, browser type,
                device info, pages you visit, and how you use the Site.
              </li>
              <li>
                <strong>Location</strong>: An approximate location based on your
                IP address.
              </li>
              <li>
              ...
              <li>
                <strong>Your Input</strong>: Reviews, comments, or questions you
                share with us.
              </li>
            </ul>
            <hr />
            ...
            <p>
              We use your information to run our business and make your shopping
              experience better:
            </p>
            <ul>
              <li>
              ...
              <li>
                <strong>Personalization</strong>: To suggest products you might
                like based on your browsing or purchases.
              </li>
              <li>
                <strong>Legal Stuff</strong>: To follow laws, prevent fraud, or
            ...
            <ul>
              <li>
                <strong>See Your Data</strong>: Ask for a copy of what we have.
              </li>
              <li>
            ...
            <p>
              ...
              extra rights, like opting out of data “sales” or sharing. We don’t
              sell or share info of anyone under 16 without clear permission.
            </p>
            <hr />
            ...
            <p>
              We protect your info with encryption and other safeguards, but no
              system is 100% safe. We keep your data only as long as we need
              it—like for fulfilling orders or meeting legal rules. For example,
              we hold onto order details for accounting purposes.
            </p>
            <hr />
            <h3 id="7-childrens-privacy">7. Children’s Privacy</h3>
            <p>
              Our Site isn’t for kids under 13. We don’t knowingly collect their
              info. If we find out we have, we’ll delete it fast.
            </p>
            <hr />
            <h3 id="8-international-users">8. International Users</h3>
            <p>
              Since our Site is U.S.-based, your info comes to the U.S. when you
              use it. Privacy laws here might not match your home country’s, but
              by shopping with us, you’re okay with that.
            </p>
            <hr />
            <h3 id="9-updates-to-this-policy">9. Updates to This Policy</h3>
            <p>
              We might tweak this policy as our business grows. Changes will
              show up here with a new “Last Updated” date. Keep using the Site,
              and you’re agreeing to the updates.
            </p>
            <hr />
