    ...
    <>
      <div className="pt-5 flex flex-col gap-8 w-full max-w-[1016px] mx-auto px-5 min-[1068px]:p-0">
        <div className="w-full flex flex-wrap gap-4">
          <div className="flex flex-col gap-2 items-start w-full max-w-60 min-[375px]:w-[calc(50%-8px)] rounded-xl p-5 relative cursor-pointer border transition bg-white active:border-[#b9bfc9] lg:hover:border-[#b9bfc9]">
