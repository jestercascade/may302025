...
//               if (item.type === "product") {
//                 return (
//                   <div key={item.index} className="p-5 border-b border-gray-200">
//                     <div className="flex gap-4">
//                       <div className="flex items-center">
//                         <div
//                           onClick={() => toggleItem(item.variantId)}
...
//                                   ${formatPrice(item.pricing.salePrice)}
//                                 </span>
//                               </div>
//                             ) : (
//                               <span className="font-medium text-gray-900">${formatPrice(item.pricing.basePrice)}</span>
//                             )}
//                           </div>
//                         </div>
//                         <div className="mt-2">{formatOptions(item.selectedOptions)}</div>
...
//                   <div
//                     key={item.index}
//                     className="p-5 bg-gradient-to-b from-amber-50 to-amber-100 border border-amber-200 relative rounded-lg my-2 mx-1 shadow-sm"
//                   >
//                     <div className="flex items-center justify-between mb-4">
//                       <div className="flex items-center gap-2">
//                         <div className="bg-white bg-opacity-80 p-2 rounded-full shadow-sm border border-[#fceddf]">
//                           <Gift color="#d97706" size={18} />
//                         </div>
//                         <span className="font-medium text-amber">Bundle Collection</span>
//                       </div>
//                       <div className="flex items-center ml-2">
//                         <div
//                           onClick={() => toggleItem(item.variantId)}
...
//                       </div>
//                       <div className="flex items-center">
//                         {item.pricing.salePrice && item.pricing.basePrice > item.pricing.salePrice && (
//                           <div className="mr-2 bg-gradient-to-r from-amber-400 to-amber-500 text-white px-3 py-1 text-xs font-medium rounded-full shadow-sm">
//                             Save ${(item.pricing.basePrice - item.pricing.salePrice).toFixed(2)}
//                           </div>
//                         )}
//                         <div className="bg-white bg-opacity-70 backdrop-blur-sm px-3 py-1.5 rounded-lg shadow-sm border border-[#fceddf]">
//                           {item.pricing.salePrice ? (
//                             <>
//                               <span className="text-gray-400 line-through text-sm">
//                                 ${formatPrice(item.pricing.basePrice)}
//                               </span>
//                               <span className="font-medium text-amber ml-2">
//                                 ${formatPrice(item.pricing.salePrice)}
//                               </span>
//                             </>
//                           ) : (
//                             <span className="font-medium text-amber">${formatPrice(item.pricing.basePrice)}</span>
//                           )}
//                         </div>
//                       </div>
//                     </div>
...
//                                   Object.values(product.selectedOptions)
//                                     .sort((a, b) => a.groupDisplayOrder - b.groupDisplayOrder)
//                                     .map((option, idx) => (
//                                       <span
//                                         key={idx}
//                                         className="bg-white bg-opacity-60 text-amber text-xs px-2.5 py-1 rounded-full border border-[#fceddf]"
//                                       >
//                                         {option.value}
//                                       </span>
//                                     ))}
